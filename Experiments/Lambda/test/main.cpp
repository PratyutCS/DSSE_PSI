...
void Lambda_Update(DSSE &FAST_, vector<int> &Keyword_Space)
{
    ...
    cout << "Average client-side update time (μs): " << fixed << setprecision(4) << avg_client_time << endl;
    cout << "Average server-side update time (μs): " << fixed << setprecision(4) << avg_server_time << endl;
...
void Lambda_Search(DSSE &FAST_, vector<int> &Keyword_Space, tuple<int, int> &range_query)
{
    ...
    cout << "Client: Search Time = " << fixed << setprecision(4) << s_cd.count()  << " μs" << endl;
    ...
    cout << "Server: Search Time = " << fixed << setprecision(4) << s_sd.count() << " μs"<< endl;
