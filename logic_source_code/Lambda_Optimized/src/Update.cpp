...
void Update_client(DSSE &FAST_, bool op, const string &ind, const int &ind_index, const int &keyword, const vector<int> &Keyword_Space, vector<tuple<string, string>> &U_list)
{
